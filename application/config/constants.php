...
define('SOURCED',1);
define('SOURCED_TEXT','Sourced');
define('FOR_SCREENING',2);
define('FOR_SCREENING_TEXT','For screening');
define('AWAITING_CV',3);
define('AWAITING_CV_TEXT','Awaiting CV');
define('CV_FOR_REVIEW',4);
define('CV_FOR_REVIEW_TEXT','CV for review');
define('FOR_PAPER_SCREENING',5);
define('FOR_PAPER_SCREENING_TEXT','For paper screening');
define('FOR_INTERVIEW',6);
define('FOR_INTERVIEW_TEXT','For interview');
define('FOR_EXAM',7);
define('FOR_EXAM_TEXT','For exam');
define('AWAITING_RESULT',8);
define('AWAITING_RESULT_TEXT','Awaiting result');
define('ENDORSED',9);
define('ENDORSED_TEXT','Endorsed');
define('FOR_JO',10);
define('FOR_JO_TEXT','For JO');
define('FOR_PEME',11);
define('FOR_PEME_TEXT','For PEME');
define('NOT_INTERESTED',12);
define('NOT_INTERESTED_TEXT','Not interested');
define('NOT_EXPLORING',13);
define('NOT_EXPLORING_TEXT','Not exploring');
define('NOT_PURSUING',14);
define('NOT_PURSUING_TEXT','Not pursuing');
define('UNRESPONSIVE',15);
define('UNRESPONSIVE_TEXT','Unresponsive');
define('NO_SHOW',16);
define('NO_SHOW_TEXT','No show');
define('NOT_QUALIFIED',17);
define('NOT_QUALIFIED_TEXT','Not qualified');
define('FAILED',18);
define('FAILED_TEXT','Failed');
define('KEEP_PROFILE',19);
