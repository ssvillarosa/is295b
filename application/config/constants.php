...
define('COOKIE_DASHBOARD_ASSIGNED_TO_ME_ORDER_BY','dashboard_assigned_to_me_order_by');
define('COOKIE_DASHBOARD_ASSIGNED_TO_ME_ORDER','dashboard_assigned_to_me_order');
...
define('ACTIVITY_TYPE_ADDED_TO_PIPELINE',8);
define('ACTIVITY_TYPE_ADDED_TO_PIPELINE_TEXT','Added to Pipeline');
define('ACTIVITY_CANDIDATE_SUBMIT_APPLICATION',9);
define('ACTIVITY_CANDIDATE_SUBMIT_APPLICATION_TEXT','Candidate applied');