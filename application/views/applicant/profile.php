            ...
            <div class="col-md-8">
                <section id="content" >
                    ...
                    <?php if(isset($error_message)): ?>
                        ...
                        <?php return; ?>
                    <?php endif; ?>
                    <?php echo form_open('applicant/profileUpdate','id="updateApplicantForm"'); ?>
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <a href="<?php echo site_url('dashboard/applicantOverview') ?>" class="btn btn-secondary">Cancel</a>
                        </div>
                    </form>
                </section>
            </div>
