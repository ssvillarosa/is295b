    ...
    <nav>
        <ul class="pagination justify-content-center mb-0 font-weight-bold">
            <li class="page-item <?php echo strval($currentPage) === "1" ? 'disabled' : ''; ?>">
                <button class="page-link" onclick="loadEventsPage(1);">&#60;&#60;</button>
            </li>
            <li class="page-item <?php echo strval($currentPage) === "1" ? 'disabled' : ''; ?>">
                <button class="page-link" 
                    onclick="loadEventsPage(<?php echo ($currentPage > 1 ? $currentPage - 1 : 1) ?>);"
                   >&#60;</button>
            </li>
            <?php for($page=$currentPage-1;$page<$currentPage+2;$page++): ?>
                ...
                <?php else: ?>
                    <li class="page-item">
                        <button class="page-link" onclick="loadEventsPage(<?php echo $page; ?>);">
                            <?php echo $page; ?>
                        </button>
                    </li>
                <?php endif; ?>
            ...
            <li class="page-item <?php echo strval($currentPage) === strval($totalPage) ? 'disabled' : ''; ?>">
                <button class="page-link" 
                    onclick="loadEventsPage(<?php echo ($currentPage < $totalPage ? $currentPage + 1 : $totalPage); ?>);">&#62;</button>
            </li>                            
            <li class="page-item <?php echo strval($currentPage) === strval($totalPage) ? 'disabled' : ''; ?>">
                <button class="page-link"
                   onclick="loadEventsPage(<?php echo $totalPage ?>);">&#62;&#62;</button>
            </li>
        </ul>
    </nav>
</div>