...
<div class="table_toolbar d-flex">
        <button onclick="$('#add_job_order_dialog').fadeIn();" class="btn btn-primary">
            Add Applicant to Job Order
        </button>
</div>
    ...
    <table class="table table-hover" id="pipeline_table">
        <thead>
            <tr>
                ...
                <th class="text-left">Job Order Title</th>
...
<?php $this->view('pipeline/addJobOrder');